...
{
       0,     0,     3,     7,    10,    11,    12,    18,    19,    22,
      23,    25,    27,    28,    29,    36,    37,    42,    45,    46,
      53,    56,    59,    60,    64,    65,    67,    68,    71,    72
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      18,     0,    -1,    19,    28,    23,    -1,    20,    23,    -1,
      -1,    -1,     3,    21,    35,    22,     6,    -1,    -1,    23,
      24,    -1,    -1,    15,    -1,    25,    -1,    -1,    -1,     5,
      12,    26,    35,    27,     6,    -1,    -1,    16,    29,    35,
      30,    -1,     8,     9,    -1,    -1,     9,    31,    32,    10,
      34,     9,    -1,    32,    14,    -1,    32,    24,    -1,    -1,
      32,    33,    28,    -1,    -1,    12,    -1,    -1,    35,    36,
      -1,    -1,    12,     7,    13,    -1
};
...
static const char *const yytname[] =
{
  ...
  "element", "@5", "empty_or_content", "@6", "content", "@7", "name_opt",
...
#line 51 "parser.y"
  ...
  case 12:
#line 57 "parser.y"
    { free((yyvsp[(2) - (2)].s)); xml_parser.stack.push_back(&xml_parser.parse_tree.xml); }
    break;
...
#line 59 "parser.y"
  ...
  case 15:
#line 64 "parser.y"
    { xml_parser.current().name=(yyvsp[(1) - (1)].s);
                                  free((yyvsp[(1) - (1)].s));
				}
    break;
...
#line 74 "parser.y"
  ...
  case 20:
#line 78 "parser.y"
    { xml_parser.current().data+=xmlt::unescape((yyvsp[(2) - (2)].s)); free((yyvsp[(2) - (2)].s)); }
    break;
...
#line 98 "parser.y"
    { xml_parser.current().set_attribute(
                                    xmlt::unescape((yyvsp[(1) - (3)].s)), xmlt::unescape((yyvsp[(3) - (3)].s)));
                                  free((yyvsp[(1) - (3)].s)); free((yyvsp[(3) - (3)].s));}
    break;


/* Line 1267 of yacc.c.  */
#line 1465 "xml_y.tab.cpp"
      default: break;
    }
