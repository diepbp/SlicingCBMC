...
//  std::cout << "before calling: " << identifier << " " << type << " " << map_entry.width << " " << map_entry.literal_map.size() << std::endl;
...
//  std::cout << identifier << ": literals: " << literals.size() << " width: " << width << " map_entry.literal_map: " << map_entry.literal_map.size() << std::endl;
