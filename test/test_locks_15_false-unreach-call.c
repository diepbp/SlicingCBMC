...
int main()
{
    ...
    // unlock phase
        if (p1 != 0) {
            if (lk1 != 1) 
                __CPROVER_assert(lk1 == 1,""); // assertion failure
            lk1 = 0;
        } else {
        ...
        if (p2 != 0) {
            if (lk2 != 1) 
                __CPROVER_assert(lk2 == 1,"false"); // assertion failure
            lk2 = 0;
        } else { 
            __CPROVER_assert(p2 != 0,"false");
        }

        if (p3 != 0) {
            if (lk3 != 1) 
                __CPROVER_assert(lk3 == 1,"false"); // assertion failure
            lk3 = 0;
        } else {
        ...
        if (p4 != 0) {
            if (lk4 != 1) 
                __CPROVER_assert(lk4 == 1,"false"); // assertion failure
            lk4 = 0;
        } else {
        ...
        if (p5 != 0) {
            if (lk5 != 1) 
                __CPROVER_assert(lk5 == 1,"false"); // assertion failure
            lk5 = 0;
        } else {
        ...
        if (p6 != 0) {
            if (lk6 != 1) 
                __CPROVER_assert(lk6 == 1,"false"); // assertion failure
            lk6 = 0;
        } else {
        }
        ...
        if (p7 != 0) {
            if (lk7 != 1) 
                __CPROVER_assert(lk7 == 1,"false"); // assertion failure
            lk7 = 0;
        } else {
        ...
        if (p8 != 0) {
            if (lk8 != 1) 
                __CPROVER_assert(lk8 == 1,"false"); // assertion failure
            lk8 = 0;
        } else {
        ...
        if (p9 != 0) {
            if (lk9 != 1) 
                __CPROVER_assert(lk9 == 1,"false"); // assertion failure
            lk9 = 0;
        } else {
        ...
        if (p10 != 0) {
            if (lk10 != 1) 
                __CPROVER_assert(lk10 == 1,"false"); // assertion failure
            lk10 = 0;
        } else {
        ...
        if (p11 != 0) {
            if (lk11 != 1) 
                __CPROVER_assert(lk11 == 1,"false"); // assertion failure
            lk11 = 0;
        } else {
        ...
        if (p12 != 0) {
            if (lk12 != 1) 
                __CPROVER_assert(lk12 == 1,"false"); // assertion failure
            lk12 = 0;
        } else {
        ...
        if (p13 != 0) {
            if (lk13 != 1) 
                __CPROVER_assert(lk13 == 1,"false"); // assertion failure
            lk13 = 0;
        } else {
        ...
        if (p14 != 0) {
            if (lk14 != 1) 
                __CPROVER_assert(lk14 == 1,"false"); // assertion failure
            lk14 = 0;
        } else { 
            __CPROVER_assert(p14 != 0,"false");
        }

        if (p15 != 0) {
            if (lk15 != 1) 
                __CPROVER_assert(lk15 == 1,"false"); // assertion failure
            lk15 = 0;
        } else {
