...
struct variable_struct
{
	...
	variable_struct(std::string _name, std::string _proc)
	{
		name = _name;
		proc = _proc;
		is_parameter = false;
	...
	variable_struct(int _type, std::string _name, std::string _proc)
	{
		type = _type;
		name = _name;
		proc = _proc;
	...
	variable_struct(int _type, std::string _name, std::string _proc, bool _param)
		{
			type = _type;
			name = _name;
			proc = _proc;
...
struct cex_node
{
	...
	cex_node(std::string _proc, int _line)
	{
		line = _line;
		proc = _proc;
	}

	cex_node(std::string _proc, int _line, int _thread)
	{
		line = _line;
		thread = _thread;
		proc = _proc;
